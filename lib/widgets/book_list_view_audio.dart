...
class BookListViewAudio extends StatelessWidget {
  final String title;
  final String image;
  final Function onTapButton;
  final Function onTapBook;

  BookListViewAudio(this.title, this.image, this.onTapButton, this.onTapBook);
...
class EBookAndAudioBookItemView extends StatelessWidget {
  ...
  EBookAndAudioBookItemView(this.image);
