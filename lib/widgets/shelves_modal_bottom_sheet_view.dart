...
class ShelvesModalBottomSheetView extends StatelessWidget {
  final Function onTapAddToShelf;

  ShelvesModalBottomSheetView(this.onTapAddToShelf);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        ModalBottomSheetListTitleView(Icons.add, "Add to shelves..."),
        ModalBottomSheetListTitleView(Icons.delete, "Remove from shelves...",
            onTapButton: this.onTapAddToShelf),
        ModalBottomSheetListTitleView(Icons.delete, "Remove from My book"),
